...
<div class="card border-primary mb-3">
    <div class="card-body">
        <button class="btn btn-outline-success" id="tambah_barang"><i class="fas fa-fw fa-plus-circle"></i> Tambah</button>
        ...
        if (list_id.length > 0) {
            if (confirm('Yakin ingin menghapus ' + list_id.length + ' data ?')) {
                $.ajax({
                    ...
                    url: "<?php echo site_url('barang/ajax_bulk_delete') ?>",
                    dataType: "JSON",
                    success: function(data) {
                        if (data.status) {
                            reload_table();
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4" for="nama">Nama Barang</label>
                            <div class="col-md">
                                <input id="nama" name="nama" placeholder="Nama Barang" class="form-control" type="text" maxlength="128" min="3">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md">
                                <input id="harga" name="harga" placeholder="Harga" class="form-control" type="number" min="0">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
